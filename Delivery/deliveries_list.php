            ...
            <nav class="mt-6 flex-1">
                <ul class="space-y-1 px-4">
                 ...
                 opacity-0 group-hover:opacity-100 translate-x-[-10px] group-hover:translate-x-0">
                    ...
                    <li>
                        <a href="../Delivery/deliveries_list.php" class="flex items-center px-4 py-3 bg-blue-50 text-blue-600 rounded-lg font-medium">
            ...
            <div
                ...
                <div class="bg-white border-b border-gray-100 shadow-sm p-4 transition-all duration-300 ease-in-out">
                    <div class="flex items-center justify-between">
                        <h1 class="text-2xl font-semibold text-blue-500">Manage Deliveries</h1>
